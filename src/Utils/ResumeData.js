export const content = [
    ...
    },
    {
        ...
        3.  Analysed latest advancements in Retrieval-Augmented Generation (RAG) applications involving LLMs and employed AWS services such as AWS Bedrock to support project needs`
    },
    {
        type: "Experience",
        title: "NTU RESEARCH",
    ...
    },
    {
        type: "Experience",
        title: "GRAB LIMITED",
        position: { x: 6, z: -42 }, // North (Right Back)
        rotation: 0,
        text: `Field Operations Specialist
        ...
        3. Ensured safe and proper operation of autonomous delivery robot and engaged public and tourists regarding the future of autonomous logistics and delivery.`
    },
    {
        type: "Education",
        title: "NTU SINGAPORE",
        position: { x: 30, z: 0 }, // East (Center)
        rotation: 0,
    ...
    },
    {
        ...
        position: { x: 36, z: 8 }, // East (Right)
        rotation: 0,
        text: `Entrepreneurial Studies
        Jul 2023
