...
Built with modern web technologies and advanced AI assistance:

*   **Core**: Javascript, HTML5, CSS3
*   **3D & Physics**: Three.js, Ammo.js
*   **Animation**: GSAP
*   **Build Tool**: Vite
*   **Development Assistant**: Google's **Antigravity** agent (powered by **Gemini 3**)
